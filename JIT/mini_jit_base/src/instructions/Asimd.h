...
class mini_jit::instructions::Asimd {
  public:
     ...
     *
     * @param i_regSimdDes SIMD&FP destination register.
     * @param i_regSimdSrc0 first SIMD&FP source register holding the multiplicand.
     * @param i_regSimdSrc1 second SIMD&FP source register holding the addend.
     * @param i_regSimdSrc2 third SIMD&FP source register holding the multiplier.
     * @param i_regSize size of the registers.
     *
     * @return instruction.
     **/
    static uint32_t dpFmadd( uint8_t   i_regSimdDes,
                             uint8_t   i_regSimdSrc0,
     ...
     *
     * @param i_regSimdDes SIMD&FP destination register.
     * @param i_regSimdSrc0 first SIMD&FP source register.
     * @param i_regSimdSrc1 second SIMD&FP source register.
     * @param i_arrSpec arrangement specifier.
     *
     * @return instruction.
     **/
    static uint32_t dpFmlaVector( uint8_t   i_regSimdDes,
                                  uint8_t   i_regSimdSrc0,
                                  uint8_t   i_regSimdSrc1,
                                  arrspec_t i_arrSpec );

    /**
     * Gets the machine code for fmla (element).
     *
     * @param i_regSimdDes SIMD&FP destination register.
     * @param i_regSimdSrc0 first SIMD&FP source register.
     * @param i_regSimdSrc1 second SIMD&FP source register.
     * @param i_arrSpec arrangement specifier.
     * @param i_index index w.r.t. second source register.
     *
     * @return instruction.
     **/
    static uint32_t dpFmlaElement( uint8_t i_regSimdDes,
                                   uint8_t i_regSimdSrc0,
                                   uint8_t i_regSimdSrc1,
                                   uint8_t i_arrSpec,
                                   uint8_t i_index );
