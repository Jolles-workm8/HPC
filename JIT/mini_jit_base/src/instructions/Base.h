...
public:
   ...
   * @return instruction.
   **/
  static uint32_t bCbnz(uint8_t i_regGp, int32_t i_imm19, uint8_t i_size);
   ...
   * @return instruction.
   **/
  static uint32_t dpMovImm(uint8_t i_regGp, uint16_t i_imm16, uint8_t i_size);
   ...
   * @return instruction.
   **/
  static uint32_t dpAddImm(uint8_t i_regGpDes, uint8_t i_regGpSrc,
                           uint16_t i_imm12, uint8_t i_size);
   ...
   * @return instruction.
   **/
  static uint32_t dpSubImm(uint8_t i_regGpDes, uint8_t i_regGpSrc,
                           uint16_t i_imm12, uint8_t i_size);
  /**
   * Gets the machine code for madd
   *
   * @param i_regGpDes general purpose destination register.
   * @param i_regGpSrc1 general purpose source register holding the
   *multiplicand.
   * @param i_regGpSrc2 general purpose source register holding the multiplier.
   * @param i_regGpSrc1 general purpose source register holding the addend.
   * @param i_size 32-bit version if 0, 64-bit version if 1.
   *
   * @return instruction.
   **/
  static uint32_t dpMAdd(uint8_t i_regGpDes, uint8_t i_regGpSrc1,
                         uint8_t i_regGpSrc2, uint8_t i_regGpSrc3,
                         uint8_t i_size);
};
